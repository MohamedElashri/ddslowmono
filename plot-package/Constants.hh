...

{
  ...
  const std::string DATA_CHECK_FILE =
    ...
    "Monopole_trivial_DataCheck_Tree.root";
  ...
  const std::string DATA_RECO_FILE =
     ...
     "Monopole_Tree_IMPROVED.root";

  //  "Monopole_Tree_Plain.root";

  const std::string DATA_QUALITY_FILE =

    "ddslowmono_raw_files_23419_metadata.csv";
  ...
  const std::string MC_RECO_FILE =
    ...
    "MC_RECO_TRIVIAL.root";

  //"191119_Monpole_Tree_MC_0.9dEdx.root";

  // "data/191119_Monpole_Tree_MC_0.9dEdx.root";

  const std::string MC_RECO_FILE_2 =

// proposed model / with new hit removal parameter (10)

 //   "MC_RECO_Proposed.root";

   "MC_RECO_IMPROVED_2.root";
...
//   const std::string MC_BETA_NAME      = "5.0e-04";
  ...
  const double LIVE_TIME               = 321295; // s

  const double LIVE_TIME_DDT_CORRECTED = 320451; // s
  ...
  std::vector<std::string> BRANCH_NAMES =

    {
      ...
      "reco_track_1_most_missing_planes_xz",

      "reco_track_1_most_missing_planes_yz",
      ...
      "reco_track_2_most_missing_planes_xz",

      "reco_track_2_most_missing_planes_yz",
      ...
      "reco_track_3_most_missing_planes_xz",

      "reco_track_3_most_missing_planes_yz",
  ...
  std::vector<std::string> DATA_CHECK_BRANCH_NAMES =
